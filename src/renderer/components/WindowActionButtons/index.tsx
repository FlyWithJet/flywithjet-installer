...
export const WindowButtons: React.FC = () => {
    ...
    const openGithub = () => shell.openExternal("https://github.com/FlyWithJet/A318/issues/new/choose");
    ...
    const handleClose = () => {
        ...
        const anyInstalling = Object.values(installStatuses).some((it:any) => InstallStatusCategories.installing.includes(it.status));
