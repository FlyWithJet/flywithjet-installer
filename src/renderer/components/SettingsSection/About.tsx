    ...
    return (
        <div className="h-full flex flex-col gap-y-8 px-16 justify-center">
            <div className="flex flex-row items-center gap-x-10">
                <img className="cursor-pointer" src={FbwTail} width={60} onClick={handleLogoClick} style={{ transform: `rotate(${logoRotation}deg)`, transition: 'transform 200ms linear' }} />

                <div className="flex flex-col gap-y-3">
                    <span className="text-4xl font-manrope font-bold">FlyWithJet Installer</span>
            ...
            <div className="flex flex-col justify-center">
                <span className="text-2xl">Copyright (c) 2022-2023 FlyWithJet Simulations and its contributors</span>
                ...
                <a
                    ...
                    onClick={handleOpenThirdPartyLicenses}
                >
